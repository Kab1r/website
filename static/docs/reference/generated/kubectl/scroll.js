$(document).ready(function() {
  /**
   * TODO: Refactor with intent toward pure functions. Mutation of state can
   * lead to bugs and difficult debugging.
   */
  ...
  function scrollActions(scrollPosition) {
    ...
    var activeSubSection, prevL1Nav, currL1Nav, prevL2Nav, currL2Nav;
