...
如果您已在本地安装 [Minikube](zh/docs/tasks/tools/install-minikube/)，也可以按照
本教程操作。
...
[_Deployment_](zh/docs/concepts/workloads/controllers/deployment/) 检查 Pod 的健
康状况，并在 Pod 中的容器终止的情况下重新启动新的容器。Deployment 是管理 Pod 创
建和扩展的推荐方法。
