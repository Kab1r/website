...
kemudian kamu buat lagi rilis _frontend_ buku tamu yang membawa label `track`
...
Tiap `kubectl apply`, atau perintah lain yang memodifikasi konfigurasi seperti
