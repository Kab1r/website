...
You can use 2 TopologySpreadConstraints to control the Pods spreading on both
zone and node:
...
- If the incoming Pod has `spec.nodeSelector` or `spec.affinity.nodeAffinity`
...
smoothly. See
[Motivation](https://github.com/kubernetes/enhancements/blob/master/keps/sig-scheduling/20190221-even-pods-spreading.md#motivation)
for more details.
