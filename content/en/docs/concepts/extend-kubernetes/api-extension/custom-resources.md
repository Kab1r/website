...
- Directly storing large amounts of data (e.g. > a few kB per object, or >1000s
  of objects).
...
When you create a custom resource, either via a CRDs or an AA, you get many
...
resources. The go and python client libraries do.
