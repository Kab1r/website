...
To demonstrate Horizontal Pod Autoscaler we will use a custom docker image based
...
Using external metrics requires knowledge of your monitoring system; the setup
