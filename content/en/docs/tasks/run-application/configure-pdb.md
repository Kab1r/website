...
When you specify the value as a percentage, it may not map to an exact number of
...
If you set `maxUnavailable` to 0% or 0, or you set `minAvailable` to 100% or the
