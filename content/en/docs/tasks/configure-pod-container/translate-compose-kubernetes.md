...
The `*-replicationcontroller.yaml` files contain the Replication Controller
...
- `kompose.service.expose` defines if the service needs to be made accessible
...
{{< note >}} The controller object could be `deployment` or
