...
1. A validating webhook ensures all references to GMSAs are authorized to be
...
Following are the steps for generating a GMSA credential spec YAML manually in
