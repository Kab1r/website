...
In version 1.6+, you can opt out of automounting API credentials for a service
...
Now you can confirm that the newly built secret is populated with an API token
...
{{% capture whatsnext %}} See also the
