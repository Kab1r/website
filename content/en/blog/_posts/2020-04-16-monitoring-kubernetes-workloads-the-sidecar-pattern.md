...
The dynamic nature of Kubernetes requires a dynamic approach to monitoring that
...
In this tutorial, we’ll configure a simple check with the Nagios `check_http`
plugin.
