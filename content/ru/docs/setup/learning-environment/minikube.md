...
Если в столбце вывода `STATUS` выводится `ContainerCreating`, значит под все еще
создается:
...
{{< note >}} Смотрите файл
[DRIVERS](https://git.k8s.io/minikube/docs/drivers.md) для получения подробной
информации о поддерживаемых драйверах и как устанавливать плагины. {{< /note >}}

- virtualbox
- vmwarefusion
- kvm2
  ([установка драйвера](https://git.k8s.io/minikube/docs/drivers.md#kvm2-driver))
- hyperkit
  ([установка драйвера](https://git.k8s.io/minikube/docs/drivers.md#hyperkit-driver))
- hyperv
  ([установка драйвера](https://github.com/kubernetes/minikube/blob/master/docs/drivers.md#hyperv-driver))
...
- vmware
  ([установка драйвера](https://github.com/kubernetes/minikube/blob/master/docs/drivers.md#vmware-unified-driver))
...
При использовании одной виртуальной машины для Kubernetes легко повторно
...
Допустимые ключи можно найти в документации по `componentconfigs` в Kubernetes
...
[панели управления Kubernetes](/docs/tasks/access-application-cluster/web-ui-dashboard/),
...
Minikube создаёт виртуальную машину, включающая в себя Kubernetes и демон
